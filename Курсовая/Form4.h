...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			// oleDbSelectCommand1
			// 
			this->oleDbSelectCommand1->CommandText = L"SELECT        Код, Преподаватель, Класс, Предмет, ДЗ, Дата\r\nFROM            Табли" 
				L"ца1\r\nWHERE        (Преподаватель LIKE \?) AND (Дата BETWEEN \? - 1 AND \?) AND (Кла" 
				L"сс LIKE \?)";
			...
			this->oleDbSelectCommand1->Parameters->AddRange(gcnew cli::array< System::Data::OleDb::OleDbParameter^  >(4) {(gcnew System::Data::OleDb::OleDbParameter(L"Преподаватель", 
				System::Data::OleDb::OleDbType::WChar, 255, L"Преподаватель")), (gcnew System::Data::OleDb::OleDbParameter(L"Дата", System::Data::OleDb::OleDbType::Date, 
				0, L"Дата")), (gcnew System::Data::OleDb::OleDbParameter(L"Дата1", System::Data::OleDb::OleDbType::Date, 0, L"Дата")), (gcnew System::Data::OleDb::OleDbParameter(L"Класс", 
				System::Data::OleDb::OleDbType::WChar, 255, L"Класс"))});
			// 
			// oleDbConnection1
			// 
			this->oleDbConnection1->ConnectionString = L"Provider=Microsoft.Jet.OLEDB.4.0;Data Source=C:\\БД\\ДЗ.mdb";
			// 
			// oleDbInsertCommand1
			// 
			this->oleDbInsertCommand1->CommandText = L"INSERT INTO `Таблица1` (`Преподаватель`, `Класс`, `Предмет`, `ДЗ`, `Дата`) VALUES" 
				L" (\?, \?, \?, \?, \?)";
			...
			this->oleDbInsertCommand1->Parameters->AddRange(gcnew cli::array< System::Data::OleDb::OleDbParameter^  >(5) {(gcnew System::Data::OleDb::OleDbParameter(L"Преподаватель", 
				System::Data::OleDb::OleDbType::VarWChar, 0, L"Преподаватель")), (gcnew System::Data::OleDb::OleDbParameter(L"Класс", System::Data::OleDb::OleDbType::VarWChar, 
				0, L"Класс")), (gcnew System::Data::OleDb::OleDbParameter(L"Предмет", System::Data::OleDb::OleDbType::VarWChar, 0, L"Предмет")), 
				(gcnew System::Data::OleDb::OleDbParameter(L"ДЗ", System::Data::OleDb::OleDbType::VarWChar, 0, L"ДЗ")), (gcnew System::Data::OleDb::OleDbParameter(L"Дата", 
				System::Data::OleDb::OleDbType::Date, 0, L"Дата"))});
			// 
			// oleDbUpdateCommand1
			// 
			...
			this->oleDbUpdateCommand1->Parameters->AddRange(gcnew cli::array< System::Data::OleDb::OleDbParameter^  >(16) {(gcnew System::Data::OleDb::OleDbParameter(L"Преподаватель", 
				...
				0, L"Класс")), (gcnew System::Data::OleDb::OleDbParameter(L"Предмет", System::Data::OleDb::OleDbType::VarWChar, 0, L"Предмет")), 
				(gcnew System::Data::OleDb::OleDbParameter(L"ДЗ", System::Data::OleDb::OleDbType::VarWChar, 0, L"ДЗ")), (gcnew System::Data::OleDb::OleDbParameter(L"Дата", 
				System::Data::OleDb::OleDbType::Date, 0, L"Дата")), (gcnew System::Data::OleDb::OleDbParameter(L"Original_Код", System::Data::OleDb::OleDbType::Integer, 
				...
				System::Data::DataRowVersion::Original, nullptr)), (gcnew System::Data::OleDb::OleDbParameter(L"IsNull_Класс", System::Data::OleDb::OleDbType::Integer, 
				0, System::Data::ParameterDirection::Input, static_cast<System::Byte>(0), static_cast<System::Byte>(0), L"Класс", System::Data::DataRowVersion::Original, 
				true, nullptr)), (gcnew System::Data::OleDb::OleDbParameter(L"Original_Класс", System::Data::OleDb::OleDbType::VarWChar, 
				0, System::Data::ParameterDirection::Input, false, static_cast<System::Byte>(0), static_cast<System::Byte>(0), L"Класс", 
				...
				System::Data::DataRowVersion::Original, nullptr)), (gcnew System::Data::OleDb::OleDbParameter(L"IsNull_ДЗ", System::Data::OleDb::OleDbType::Integer, 
				0, System::Data::ParameterDirection::Input, static_cast<System::Byte>(0), static_cast<System::Byte>(0), L"ДЗ", System::Data::DataRowVersion::Original, 
				true, nullptr)), (gcnew System::Data::OleDb::OleDbParameter(L"Original_ДЗ", System::Data::OleDb::OleDbType::VarWChar, 0, 
				System::Data::ParameterDirection::Input, false, static_cast<System::Byte>(0), static_cast<System::Byte>(0), L"ДЗ", System::Data::DataRowVersion::Original, 
				nullptr)), (gcnew System::Data::OleDb::OleDbParameter(L"IsNull_Дата", System::Data::OleDb::OleDbType::Integer, 0, System::Data::ParameterDirection::Input, 
				static_cast<System::Byte>(0), static_cast<System::Byte>(0), L"Дата", System::Data::DataRowVersion::Original, true, nullptr)), 
				(gcnew System::Data::OleDb::OleDbParameter(L"Original_Дата", System::Data::OleDb::OleDbType::Date, 0, System::Data::ParameterDirection::Input, 
				false, static_cast<System::Byte>(0), static_cast<System::Byte>(0), L"Дата", System::Data::DataRowVersion::Original, nullptr))});
			// 
			// oleDbDeleteCommand1
			// 
			...
			this->oleDbDeleteCommand1->Parameters->AddRange(gcnew cli::array< System::Data::OleDb::OleDbParameter^  >(11) {(gcnew System::Data::OleDb::OleDbParameter(L"Original_Код", 
				...
				static_cast<System::Byte>(0), L"Преподаватель", System::Data::DataRowVersion::Original, nullptr)), (gcnew System::Data::OleDb::OleDbParameter(L"IsNull_Класс", 
				System::Data::OleDb::OleDbType::Integer, 0, System::Data::ParameterDirection::Input, static_cast<System::Byte>(0), static_cast<System::Byte>(0), 
				L"Класс", System::Data::DataRowVersion::Original, true, nullptr)), (gcnew System::Data::OleDb::OleDbParameter(L"Original_Класс", 
				System::Data::OleDb::OleDbType::VarWChar, 0, System::Data::ParameterDirection::Input, false, static_cast<System::Byte>(0), 
				static_cast<System::Byte>(0), L"Класс", System::Data::DataRowVersion::Original, nullptr)), (gcnew System::Data::OleDb::OleDbParameter(L"IsNull_Предмет", 
				System::Data::OleDb::OleDbType::Integer, 0, System::Data::ParameterDirection::Input, static_cast<System::Byte>(0), static_cast<System::Byte>(0), 
				L"Предмет", System::Data::DataRowVersion::Original, true, nullptr)), (gcnew System::Data::OleDb::OleDbParameter(L"Original_Предмет", 
				System::Data::OleDb::OleDbType::VarWChar, 0, System::Data::ParameterDirection::Input, false, static_cast<System::Byte>(0), 
				static_cast<System::Byte>(0), L"Предмет", System::Data::DataRowVersion::Original, nullptr)), (gcnew System::Data::OleDb::OleDbParameter(L"IsNull_ДЗ", 
				System::Data::OleDb::OleDbType::Integer, 0, System::Data::ParameterDirection::Input, static_cast<System::Byte>(0), static_cast<System::Byte>(0), 
				L"ДЗ", System::Data::DataRowVersion::Original, true, nullptr)), (gcnew System::Data::OleDb::OleDbParameter(L"Original_ДЗ", 
				System::Data::OleDb::OleDbType::VarWChar, 0, System::Data::ParameterDirection::Input, false, static_cast<System::Byte>(0), 
				static_cast<System::Byte>(0), L"ДЗ", System::Data::DataRowVersion::Original, nullptr)), (gcnew System::Data::OleDb::OleDbParameter(L"IsNull_Дата", 
				System::Data::OleDb::OleDbType::Integer, 0, System::Data::ParameterDirection::Input, static_cast<System::Byte>(0), static_cast<System::Byte>(0), 
				...
				L"Дата", System::Data::DataRowVersion::Original, nullptr))});
			// 
			// oleDbDataAdapter1
			// 
			...
			cli::array< System::Data::Common::DataColumnMapping^ >^ __mcTemp__1 = gcnew cli::array< System::Data::Common::DataColumnMapping^  >(6) {(gcnew System::Data::Common::DataColumnMapping(L"Код", 
				L"Код")), (gcnew System::Data::Common::DataColumnMapping(L"Преподаватель", L"Преподаватель")), (gcnew System::Data::Common::DataColumnMapping(L"Класс", 
				L"Класс")), (gcnew System::Data::Common::DataColumnMapping(L"Предмет", L"Предмет")), (gcnew System::Data::Common::DataColumnMapping(L"ДЗ", 
				L"ДЗ")), (gcnew System::Data::Common::DataColumnMapping(L"Дата", L"Дата"))};
			...
			this->Таблица1BindingNavigator->Size = System::Drawing::Size(691, 25);
			...
			this->Таблица1BindingNavigatorSaveItem->Click += gcnew System::EventHandler(this, &Form4::Таблица1BindingNavigatorSaveItem_Click);
			// 
			...
			this->Таблица1DataGridView->Location = System::Drawing::Point(12, 98);
			this->Таблица1DataGridView->Name = L"Таблица1DataGridView";
			this->Таблица1DataGridView->Size = System::Drawing::Size(660, 206);
			...
			this->label2->Text = L"Введите преиод сдачи:";
			// 
			// label1
			// 
			...
			this->label1->Text = L"Введите преподавателя:";
			// 
			// dateTimePicker1
			// 
			...
			// 
			this->dataGridViewTextBoxColumn6->DataPropertyName = L"Дата";
			this->dataGridViewTextBoxColumn6->HeaderText = L"Дата сдачи";
			this->dataGridViewTextBoxColumn6->Name = L"dataGridViewTextBoxColumn6";
			// 
			// dataGridViewTextBoxColumn3
			// 
			this->dataGridViewTextBoxColumn3->DataPropertyName = L"Класс";
			this->dataGridViewTextBoxColumn3->HeaderText = L"Класс";
			...
			// 
			this->dataGridViewTextBoxColumn5->DataPropertyName = L"ДЗ";
			this->dataGridViewTextBoxColumn5->HeaderText = L"ДЗ";
			this->dataGridViewTextBoxColumn5->Name = L"dataGridViewTextBoxColumn5";
			// 
			// Таблица1BindingSource
			// 
			this->Таблица1BindingSource->DataMember = L"Таблица1";
			this->Таблица1BindingSource->DataSource = this->dataSet31;
			// 
			// dataSet31
			// 
...
#pragma endregion
	private: System::Void Таблица1BindingNavigatorSaveItem_Click(System::Object^  sender, System::EventArgs^  e) {
				 oleDbDataAdapter1->Update(dataSet31->Tables["Таблица1"]);
			 }
private: System::Void button1_Click(System::Object^  sender, System::EventArgs^  e) {
			 ...
			 oleDbDataAdapter1->Fill(dataSet31->Tables["Таблица1"]);
		 }
